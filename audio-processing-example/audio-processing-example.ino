...
// To use this example, you must connect an audio input source (e.g. microphone, line-in) and an audio
// output device to Sonatino using a 3.5mm TRRS cable. A headset device with a microphone is a good
// choice, but you can also use a TRRS adapter to connect separate audio devices.

// Be sure to read the Sonatino documentation and set the board's level selection DIP switches
// appropriately for your input and output levels.
